...
class BatchGenerator:
    ...
    def load_full_data(self):
        ...
        test_loader = torch.utils.data.DataLoader(dataset_test, batch_size=self.batch_size, shuffle=False, num_workers=6, drop_last=True)
        self.data_map = []
        return test_loader
...
def main():
    model_path = "/home/kia/Kiyanoush/UoLincoln/Projects/Tactile_control/tactile_prediction/uninversal_trainer/ACTP/saved_models/model_23_02_2022_10_38/ACTP"
    model_path_latent = "/home/kia/Kiyanoush/UoLincoln/Projects/Tactile_control/tactile_prediction/uninversal_trainer/ACTP/saved_models/model_23_02_2022_10_38/SV2P_model_latent_model"
    data_save_path = "/home/kia/Kiyanoush/UoLincoln/Projects/Tactile_control/tactile_prediction/uninversal_trainer/ACTP/saved_models/model_23_02_2022_10_38/test_results/"
    test_data_dir = "/home/kia/Kiyanoush/UoLincoln/Projects/Tactile_control/data_set/test_image_dataset_10c_10h/"
    scaler_dir = "/home/kia/Kiyanoush/UoLincoln/Projects/Tactile_control/data_set/scalars/"

    number_of_trials = np.arange(539)  # 0-22
    batch_size = 32
    context_frames = 10
    sequence_length = 10
    image_size = 0
